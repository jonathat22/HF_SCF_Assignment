...
def test_solve_Roothan_equations(mol_h2o):
    ...
    assert mo_energies == pytest.approx([-32.57830292, -8.08153571,
                                              ...
                                              -7.34714487, -4.00229867,
                                              -3.98111115])

    assert abs(mo_coeffs[0, 0]) == pytest.approx(abs(1.00154358e+00))
    assert abs(mo_coeffs[0, 1]) == pytest.approx(abs(2.33624458e-01))
    assert abs(mo_coeffs[0, 2]) == pytest.approx(abs(4.97111543e-16))
    assert abs(mo_coeffs[0, 3]) == pytest.approx(abs(8.56842145e-02))
    assert abs(mo_coeffs[0, 4]) == pytest.approx(abs(2.02299681e-29))
    assert abs(mo_coeffs[0, 5]) == pytest.approx(abs(4.82226067e-02))
    assert abs(mo_coeffs[0, 6]) == pytest.approx(abs(4.99600361e-16))
